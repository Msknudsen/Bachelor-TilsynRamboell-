...
Firebase database er blevet valgt til dette projekt, så i følgende afsnit redegøres for de beslutninger der er taget angående valget af Firebase database. \\
