...
Den grafiske brugergrænseflade for 'Login' viewet består af felter til at bruger kan indtaster sit brugernavn og kodeord. Se figur \ref{fig:OpretBrugerView}
\begin{figure}[H] % (alternativt [H])
	\centering
