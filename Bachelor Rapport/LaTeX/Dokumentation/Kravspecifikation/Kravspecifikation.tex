...
\subsubsection{Rediger af brugeroplysninger (CRS-3} \label{sec:USRedigerBruger}
...
\subsubsection{Opret fluebens opbjekt på PDF tegning (CRS-5)} \label{sec:USOpretFlueben}
...
\subsubsection{Opret pil opbjekt på PDF tegning (CRS-9)} \label{sec:USOpretPilObjekt}
...
\subsubsection{Opret minus opbjekt på PDF tegning (CRS-10)} \label{sec:USOpretMinusObjekt}
...
\subsubsection{Slet opbjekt på PDF tegning (CRS-11)} \label{sec:USSletObjekt}
...
\subsubsection{Afslut registrering på PDF tegning (CRS-12)} \label{sec:USAfslutRegPåPDF}
...
\subsubsection{Opret en registrering uden PDF tegning (CRS-13)} \label{sec:USOpretRegUdenPDF}
...
\subsubsection{Afslut registrering uden PDF tegning (CRS-14)} \label{sec:USAfslutRegUdenPDF}
\textbf{\textsc{\textcolor{RoyalBlue}{Egenskab:} Afslut registrering på PDF tegning}}\\
Som bruger\\
Ønsker jeg at kunne slette et objekt på en PDF\\
For kunne redigere min registrering på et givent projekts pdf tegning\\
...
\subsubsection{Se tilsynsrapporter (CRS-15)} \label{sec:USSeTilsynsrapporter}
...
\begin{itemize}[-]
	...
	\item Alle brugere skal kunne anvende systemet på samme tid Maks antal brugere er 100 på samme tid \textbf{(TRS-3)}
